                ...
                <div class="card-content">
                    ...
                    <div class="alert alert-primary" role="alert">
                        ...
                        <?php 
                            ...
                            $usr = $user->id_user;
                            $cr = $this->db->query("SELECT * FROM saw_alternatives a 
                            LEFT JOIN saw_evaluations e ON e.id_alternative = a.id_alternative 
                            LEFT JOIN saw_criterias c ON c.id_criteria = e.id_criteria WHERE a.id_alternative = '$id_alternatif' AND e.id_user = '$usr'")->result(); ?>
